...
@interface CHGuideViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation CHGuideViewController
...
- (void)requestData
{
    NSString *strUrl= [NSString stringWithFormat:@"%@?pageindex=%d&pagesize=20&productid=17&v=1",KSayCar_URL,self.page];
